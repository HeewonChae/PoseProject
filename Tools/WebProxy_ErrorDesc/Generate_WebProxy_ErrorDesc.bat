...
SET ProjectPath=C:\PoseProject\Web App\PoseSportsWebService\CodeGenerator
SET OutputPath1=C:\PoseProject\Web App\PoseSportsWebService\PacketBuilder\bin\Release\Proxy
SET OutputPath2=C:\PoseProject\Web App\PoseSportsWebService\PacketBuilder\bin\Release\ErrorDescription
SET CopyPath1=C:\PoseProject\Common Library\PoseSportsPredictService\PosePacket\Proxy
SET CopyPath2=C:\PoseProject\Web App\PoseSportsWebService\SportsWebService\App_Data
