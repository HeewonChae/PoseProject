...
namespace Pose_sports_statistics
{
	public static class ModelStatic
	{
		public static void InitModelMapping()
		{
			...
			var footballStandingMap = DataMapper.Resolve<APIModel.Standing, WebModel.FootballStanding>();
			footballStandingMap.Complex<APIModel.Standing, WebModel.FootballStanding>(source => source.AllPlayedInfo, dest => dest.AllPlayedInfo);
			footballStandingMap.Complex<APIModel.Standing, WebModel.FootballStanding>(source => source.HomePlayedInfo, dest => dest.HomePlayedInfo);
			footballStandingMap.Complex<APIModel.Standing, WebModel.FootballStanding>(source => source.AwayPlayedInfo, dest => dest.AwayPlayedInfo);
