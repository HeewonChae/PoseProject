    ...
    public partial class Initialize : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        is_predict_coverage = c.Boolean(nullable: false),
                        upt_time = c.DateTime(nullable: false, precision: 0),
                    })
                .PrimaryKey(t => t.id)                
                ...
                .Index(t => t.is_predict_coverage, name: "IDX_PREDICT_COVERAGE");
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        label_type = c.String(nullable: false, maxLength: 32, unicode: false),
                ...
                .PrimaryKey(t => t.seq)                
                .Index(t => new { t.fixture_id, t.label_type }, name: "IDX_FIXTURE_LABEL");
        ...
        public override void Down()
        {
            ...
            DropIndex("league", "IDX_PREDICT_COVERAGE");
