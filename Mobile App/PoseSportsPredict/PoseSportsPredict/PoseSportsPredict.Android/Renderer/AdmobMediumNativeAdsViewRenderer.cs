...
[assembly: ExportRenderer(typeof(PoseSportsPredict.Views.Common.Ads.AdmobMediumNativeAdsView), typeof(AdmobNativeAdsViewRenderer))]

namespace PoseSportsPredict.Droid.Renderer
{
    public class AdmobNativeAdsViewRenderer : ViewRenderer
    {
            ...
            if (Control == null)
            {
                ...
                listener.OnNativeAdLoaded += (s, ad) =>
                {
                    ...
                    try
                    {
                        ...
                        e.NewElement.HeightRequest = 217; // DependencyService.Resolve<IScreenHelper>().DpToPixels(83);
