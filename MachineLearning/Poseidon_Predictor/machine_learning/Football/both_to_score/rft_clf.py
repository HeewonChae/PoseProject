...
rtf_clf = RandomForestClassifier(n_estimators=122, random_state=42, min_samples_split=4, class_weight='balanced')
...
utility.save_sklearn_model(full_pipeline, dir_name, "rft_clf_bts_any.pkl")
